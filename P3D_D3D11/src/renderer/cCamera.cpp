...
namespace p3d {
    ...
    glm::mat4 cBuildCameraMatrix(const cCamera& camera)
    {
        ...
        glm::mat4 camera_matrix = glm::lookAtLH(camera.pos, look_target, glm::vec3{ 0.0f, 1.0f, 0.0f });
    ...
    {
        return glm::perspectiveLH(glm::radians(45.0f), camera.aspect, 0.1f, 400.0f);
    }
